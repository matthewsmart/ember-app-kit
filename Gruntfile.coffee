module.exports = (grunt) ->
  ...
  grunt.registerTask 'build:debug',
    "Build a development-friendly version of your app.",
    [
      'build'
  ...
  grunt.registerTask 'test',
    "Run your apps's tests once. Uses Google Chrome by default. Logs coverage output to tmp/public/coverage.",
    [
      'build:debug'
      'karma:test'
    ]
  ...
  grunt.registerTask 'test:ci',
    "Run your app's tests in PhantomJS. For use in continuous integration (i.e. Travis CI).",
    [
      'build:debug'
      'karma:ci'
    ]
  ...
  grunt.registerTask 'test:browsers',
    "Run your app's tests in multiple browsers (see tasks/options/karma.js for configuration).",
    [
      'build:debug'
      'karma:browsers'
    ]
  ...
  grunt.registerTask 'test:server',
    "Start a Karma test server. Automatically reruns your tests when files change and logs the results to the terminal.",
    [
      'build:debug'
      'karma:server'
      'connect:server'
  ...
  grunt.registerTask 'server:dist',
    "Build and preview production (minified) assets.",
    [
      'build:dist'
